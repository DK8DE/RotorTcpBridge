...
class SettingsWindow(QDialog):
    ...
    def __init__(
        ...
        self.chk_aswatch_udp.setChecked(bool(cfg.get("ui", {}).get("aswatch_udp_enabled", False)))
        self.sp_aswatch_udp_port = QSpinBox()
        self.sp_aswatch_udp_port.setRange(1, 65535)
        self.sp_aswatch_udp_port.setValue(int(cfg.get("ui", {}).get("aswatch_udp_port", 9872)))
        ...
        aswatch_row.setAlignment(Qt.AlignmentFlag.AlignLeft)
        aswatch_row.addWidget(self.chk_aswatch_udp)
        aswatch_row.addSpacing(12)
        aswatch_row.addWidget(QLabel(t("settings.aswatch_udp_port_label")))
        aswatch_row.addWidget(self.sp_aswatch_udp_port)
        aswatch_row.addStretch(1)
        aswatch_row_w = QWidget()
        aswatch_row_w.setLayout(aswatch_row)
        form_ui.addRow(aswatch_row_w)
